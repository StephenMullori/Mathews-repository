...
public class PromTicket {
	...
	public void promTicket() {
		...
		while (count == 1) {
			...
			System.out.println("to end the program enter 1 and enter anything else to end the program");

			String looptemp = input.nextLine();
			
			
			if (looptemp.equals("1")) {
				count = 0;
			}
